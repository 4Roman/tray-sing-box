...
#             a reload without a session, a second login from the tray
...
function PrepareBrowser {
    ...
    Start-Process -FilePath $edgeExe -ArgumentList @('--remote-debugging-port=9222', 'about:blank')
...
switch ($Phase) {
    ...
    'web' {
        ...
        # 7. a reload has no session; the tray item opens a new one
